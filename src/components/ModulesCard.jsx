  ...
  return (
    <div className="">
      ...
      <div className="pt-4 sm:-mt-2 2xl:mt-2">
        <h3 className="text-lg text-gray-900">{programModule.name}</h3>
        ...
        <div className="mt-4 w-80 lg:w-fit max-w-80">
          <Link to={`/module/${programModule.id}`} className=" text-purple-600 hover:underline text-base xl:text-base">
