...
const ShareButton = ({ url, title }) => (
  <div className="lg:bg-purple-600 lg:p-8 rounded-xl lg:rounded-[4rem] mt-6 w-full max-w-sm mx-auto">
    <h3 className="text-2xl font-bold mb-4 text-white hidden lg:block">Share this page</h3>
    
    <div className="flex lg:flex-col gap-2 lg:gap-4 justify-center">
